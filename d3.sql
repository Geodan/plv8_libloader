...
do language plv8 $$
	//plv8.elog(NOTICE,typeof Delaunator);
	plv8.elog(NOTICE,typeof Geotiff);
	//plv8.elog(NOTICE,JSON.stringify(Delaunator));
	...
	//plv8.elog(NOTICE,JSON.stringify(d.triangles));
